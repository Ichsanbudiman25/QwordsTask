        ...
        <div class="container-xxl py-5">
            <div class="container px-lg-5">
                <div class="section-title position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p class="mb-1">Selamat datang dilayanan kami, kami menyediakann layanan komunikasi 24/7.</p>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-5 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt text-primary me-3"></i>Jalan haji mali, no 10</p>
                        <p class="mb-2"><i class="fa fa-phone-alt text-primary me-3"></i>+628 5659937420</p>
                        <p class="mb-2"><i class="fa fa-envelope text-primary me-3"></i>ichsanbudiman12@gmail.com</p>
